...
with entrada:
  ...
  with ajuda:
    ...
    if st.button("?", type="primary", key="Método"):
      ...
      st.markdown("Caso ainda haja duvidas consulte o material guia(Informações sobre os tipos de metodo se encontram apartir da pg.98): [NBR5410](https://docente.ifrn.edu.br/jeangaldino/disciplinas/2015.1/instalacoes-eletricas/nbr-5410?page=30)")
