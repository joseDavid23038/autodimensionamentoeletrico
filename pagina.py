...
with entrada:
  ...
  with ajuda:
    ...
    if st.button("?", type="primary", key="Método"):
      ...
      st.write("Caso ainda haja duvidas consulte o material guia: [NBR5410](https://docente.ifrn.edu.br/jeangaldino/disciplinas/2015.1/instalacoes-eletricas/nbr-5410?page=98)")
