...
tabela_disjuntores = pd.read_excel("/app/autodimensionamentoeletrico/Dados/DISJUNTORES.xlsx")
tabela_agrupamento = pd.read_excel("/app/autodimensionamentoeletrico/Dados/AGRUPAMENTO.xlsx")
tabela_temperatura = pd.read_excel("/app/autodimensionamentoeletrico/Dados/TEMPERATURA.xlsx")
